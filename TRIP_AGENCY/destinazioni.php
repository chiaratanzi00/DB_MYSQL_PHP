...
//===========================  LOGICA DI AGGIUNTA DESTINAZIONE
...
$stmt = $conn->prepare("INSERT INTO destinazioni 
        (citta, paese, prezzo, data_partenza, data_ritorno, posti_disponibili)
        VALUES (?, ?, ?, ?, ?, ?)
");
...
$stmt->bind_param("ssdssii",
    ...
    echo "<div class='alert alert-success'>Destinazione aggiunta con successo!</div>";
}
...
if (isset($_GET['modifica'])) {
    ...
    $res = $conn->query("SELECT * FROM destinazioni WHERE id = $id");
...
//PREPARE
$stmt = $conn->prepare("UPDATE destinazioni
...
echo "<div class='alert alert-info'>Destinazione eliminata correttamente</div>";
}
            ...
            <?php if($destinazione_modifica): ?>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="prezzo" class="form-control" placeholder=""
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="posti_disponibili" class="form-control" placeholder="" 
    ...
    <table class="table table-striped">
        ...
        <?php while ($row = $result->fetch_assoc()) : ?>
                ...
                <td>
                    ...
                    <a class="btn btn-sm btn-danger" href="?elimina=<?= $row['id'] ?>"
